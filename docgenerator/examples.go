...
// GenerateExampleDocs writes one markdown file per preset field listed in
// titles, containing the YAML of every preset that field exposes. titles maps a
// field to its display title (e.g. "authorizationpolicies" ->
// "AuthorizationPolicy"); the file is named after the lowercased title so it
// matches the documentation page for the same type. Fields absent from titles,
// or with no presets, are skipped.
