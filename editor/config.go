...
// MetadataSource is the sole authority: YAMLTUI never auto-populates any FieldMeta
...
// level (e.g. &MyConfig{}). The editor introspects it through yamltui/schema.
//
...
// from the returned FieldMeta. All FieldMeta fields are used as-is; YAMLTUI
