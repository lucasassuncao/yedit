.PHONY: help fmt lint test test-watch test-coverage security deps tag all clean
...
all: fmt lint security test-coverage ## Run all checks (fmt + lint + security + coverage)
